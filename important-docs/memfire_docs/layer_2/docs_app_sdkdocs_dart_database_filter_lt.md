...
**URL:** https://docs.memfiredb.com/docs/app/sdkdocs/dart/database/filter/lt/
**Layer/Depth:** 2
...
[*navigate\_before* gte()](/docs/app/sdkdocs/dart/database/filter/gte/)

[lte() *navigate\_next*](/docs/app/sdkdocs/dart/database/filter/lte/)