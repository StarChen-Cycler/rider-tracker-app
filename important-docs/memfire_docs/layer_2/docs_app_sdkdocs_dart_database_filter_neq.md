...
**URL:** https://docs.memfiredb.com/docs/app/sdkdocs/dart/database/filter/neq/
**Layer/Depth:** 2
...
[*navigate\_before* eq()](/docs/app/sdkdocs/dart/database/filter/eq/)

[gt() *navigate\_next*](/docs/app/sdkdocs/dart/database/filter/gt/)