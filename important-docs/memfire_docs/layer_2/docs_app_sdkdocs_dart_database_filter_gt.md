...
**URL:** https://docs.memfiredb.com/docs/app/sdkdocs/dart/database/filter/gt/
**Layer/Depth:** 2
...
[*navigate\_before* neq()](/docs/app/sdkdocs/dart/database/filter/neq/)

[gte() *navigate\_next*](/docs/app/sdkdocs/dart/database/filter/gte/)