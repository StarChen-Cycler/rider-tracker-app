...
**URL:** https://docs.memfiredb.com/docs/app/sdkdocs/javascript/storage/storage-from-upload/
**Layer/Depth:** 1
...
[*navigate\_before* from.download()](/docs/app/sdkdocs/javascript/storage/storage-from-download/)

[from.update() *navigate\_next*](/docs/app/sdkdocs/javascript/storage/storage-from-update/)